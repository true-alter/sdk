...
answers an anonymous client, so that constructor is enough to start reading.
Worked examples live on the [`export/main`](https://github.com/true-alter/sdk/tree/export/main/examples)
branch.
...
The source each release is built and published from sits on the
[`export/main`](https://github.com/true-alter/sdk/tree/export/main) branch. This
branch carries the documentation, the release workflow and the issue tracker.
