...
export class Provider {
  ...
  async fulfil(
    ...
    // Canonical split (D-DS6, D-CO23; doctrine
    // `canonical-revenue-split-75-15-5-5-org-is-facilitator-slot`), with
    // the org-facilitated routing illustrated. The `hasMember: false`
    // branch is the pending-DR case; see the README banner and
    // shared.ts:computeSplit for the note string.
