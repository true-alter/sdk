 ...
 *
 * Auto-derived from the server's own tool catalogue and from its tier,
 * price and blast-radius registries.
 *
...
// Source of truth: the server's own tier, price and blast-radius registries.
// =============================================================================

/**
 * Tool tier mapping (L0=free, L1-L5=paid).
 * Mirrors the server's own tier registry.
 */
 ...
 * Mirrors the server's own price registry.
 * Free tools (L0) are 0.
 */
 ...
 * Mirrors the server's own blast-radius registry.
 */
