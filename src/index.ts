 ...
 * environment. Wraps the publicly advertised ~Alter MCP tools at
 * `https://mcp.truealter.com/api/v1/mcp` (38 free L0 + 9 premium L1-L5 =
 * 47 total). The live counts are in `ADVERTISED_TOOL_COUNTS` (pricing.generated).
 * First-class TypeScript types, x402 micropayment support, and ES256
...
export {
  ...
  type InvocationVerification,
  type P256PublicJwk,
  type SignInvocationOptions,
  type VerifyInvocationOptions,
} from './signing.js';

// Canonical JSON profile and the strict wire parser
export {
  CANONICAL_MAX_DEPTH,
  CANONICAL_MAX_SAFE_INTEGER,
  canonicalizeWireText,
  parseStrictWire,
} from './canonical.js';
...
// Client version-floor preflight
export {
  BelowFloorError,
  CLIENT_CHANNEL,
  CLIENT_ID,
  ...
  type ChannelFloor,
  type CheckMinVersionOptions,
  type ClientBelowFloorEnvelope,
  type FloorDocument,
  type PreflightResult,
} from './floor-preflight.js';
...
// Generated pricing surface: single source of truth for tool counts + prices
export {
  ADVERTISED_TOOL_COUNTS,
  GENERATED_TOOL_PRICING,
  GENERATED_TOOL_TIERS,
  REVENUE_SPLIT,
  TIER_PRICES,
  toolPrice,
  toolTier,
} from './pricing.generated.js';
